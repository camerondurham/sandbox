...
#ifndef YY_CALC_PARSER_HPP_INCLUDED
# define YY_CALC_PARSER_HPP_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_CALC_PARSER_HPP_INCLUDED  */
...
{
  "$end", "error", "$undefined", "TINTEGER", "TPLUS", "TMINUS", "TMULT",
  "TDIV", "TLPAREN", "TRPAREN", "TRESULT", "TEQUALS", "$accept", "result",
  "expr", YY_NULLPTR
};
#endif
...
{
       8,    11,    12,    14,    15,    16,    17,     9,    10,    11,
      12,     5,    13,     3,     1,     4,     6,     9,    10,    11,
      12
};

static const yytype_uint8 yycheck[] =
{
       6,     6,     7,     9,    10,    11,    12,     4,     5,     6,
       7,     3,     9,    11,    10,     0,     8,     4,     5,     6,
       7
};
...
#line 43 "calc.y" /* yacc.c:1646  */
    { (yyval.node) = new NInteger(*((yyvsp[0].string))); }
